...
public abstract class AbstractLedgerMngDialog extends JDialog {
	...
	private void addComponent() {
		...
		beginDateTxt.setText(String.format("%tF", DateUtils.getFirstDayOfMethod()));//本月第一天
		...
		endDateTxt.setText(String.format("%tF", new Date()));//当前时间
		...
		ledgerDataTable.getTableHeader().setReorderingAllowed(false);//2列不能换
